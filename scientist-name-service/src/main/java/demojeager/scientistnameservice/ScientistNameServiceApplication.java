package demojeager.scientistnameservice;
...
class ScientistNameResource {
	...
	public ScientistNameResource(Tracer tracer) throws IOException {
		this.tracer = tracer;
		InputStream inputStream = new ClassPathResource("static/scientists.txt").getInputStream();
